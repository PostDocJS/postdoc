...
export default class Configuration {
  static #instance;
  static #names = ['postdoc.config.mjs', 'postdoc.config.cjs', 'postdoc.config.js', 'postdoc.config.json'];
  ...
  pwa = {
    strategies: 'generateSW', registerType: 'autoUpdate', workbox: {
      globPatterns: [`**/*.{${assetsToCache.join(',')}}`]
    }
  };

  directories = {
    pages: 'docs', tests: 'test', output: 'out', layouts: 'layouts', includes: 'includes'
  };
  ...
  ignore = {
    pages: [], apidocs: ['**/node_modules/**/*', '**/node_modules/**/.*'], layouts: []
  };
  ...
  markdown = {
    options: { async: true }, extensions: [], shikiOptions: {}
  };
