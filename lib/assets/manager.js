...
const AssetBuilder = (kind) => {
  ...
  switch (kind) {
    case AssetKind.Layout:
      asset.destination.push(Configuration.layouts, kind);
      break;
    case AssetKind.Section:
      asset.destination.push(Configuration.contents, kind);
      break;
    case AssetKind.PageTest:
      asset.destination.push(Configuration.tests, kind);
      break;
    default:
