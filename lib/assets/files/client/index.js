...
/**
 * Adds an event listener to the element from the page.
...
export const attachListener = (selectors, name, listener) => {
  ...
  const detachListener = globalThis[GLOBAL_MANAGER_NAME].registerEventListener(
...
export const moveTo = (uri) =>
  globalThis[GLOBAL_MANAGER_NAME].navigate(shortenSameSiteURI(uri));
