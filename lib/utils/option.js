...
import {isObject, isNothing, panic} from './fp.js';
 ...
 */
export const isOption = (value) => isObject(value) && TYPE in value;
...
export const Option = (value) => ({
  ...
  unsafeExtract: (
    message = 'Cannot unwrap an Option object with null or undefined.'
  ) => (isNothing(value) ? panic(message) : value)
});

export const None = Option(null);
export const Some = Option;
