...
const LineBuilder = () => {
  ...
  const API = {
    ...
    /**
     * Defines a transformer which will modify
     * the final message. There is ability to
     * define multiple transformers. In that case,
     * the order of defining transformers describing
     ...
     */
    transform: (fn) => (transformers.push(fn), API)
  };
