...
import {LineBuilder, MessageBuilder, error as logError} from '../logger/index.js';
...
export const generateApiDocFiles = (
  ...
  Future.map(pipe(
    Iterable.map(createOutputPathResolver(configuration, outputDirectoryName, sourceDirectory)),
