...
const {getCacheEntryFor} = require('./cache.js');
const {
  MD_SUFFIX,
  JS_SUFFIX,
  TS_SUFFIX,
 ...
 * @property {Map<string, string|Record<string, string>|[import('./page/front-matter.js').FrontMatter| null, string]>} _cache - a cache of page's parts that
 *   are injected in a current page. Nested includes are present here too.
 */
