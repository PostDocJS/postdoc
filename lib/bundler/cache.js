 ...
 *
 * @param {KeyDescriptorPart}
 * @returns {(descriptor: KeyDescriptor) => boolean}
 */
const descriptorShouldBeFor = (part) => (descriptor) =>
  descriptor[descriptor.length - 1] === generateKey([part]);
 ...
 */
const getCacheKeyDescriptorsByParts = (parts) => {
 ...
 */
const hasCacheEntry = (keyDescriptor) =>
 ...
 * @param {KeyDescriptor} keyDescriptor
 */
const getCacheEntry = (keyDescriptor) =>
 ...
 */
const addCacheEntry = (keyDescriptor, content) => {
 ...
 * @param {KeyDescriptor} keyDescriptor
 */
const removeCacheEntry = (keyDescriptor) =>
  keyDescriptor
    .reduce(
...
exports.hasCacheEntry = hasCacheEntry;
exports.getCacheEntry = getCacheEntry;
exports.addCacheEntry = addCacheEntry;
exports.removeCacheEntry = removeCacheEntry;
exports.descriptorShouldBeFor = descriptorShouldBeFor;
exports.getCacheKeyDescriptorsByParts = getCacheKeyDescriptorsByParts;
