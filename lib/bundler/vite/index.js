 ...
 */
export const build = async (postdocConfiguration, temporaryDirectory) => {
  const config = createViteBuildConfiguration(
...
export const startServer = async (postdocConfiguration, additionalOptions) => {
  const config = createViteDevelopmentConfiguration(
    postdocConfiguration,
    (_config) => {
...
export const startPreviewServer = async (
  ...
  const config = createVitePreviewConfiguration(
    postdocConfiguration,
    (_config) => {
