...
import {sep, dirname, basename, extname, join} from 'node:path';

import {not} from '../../utils/fp.js';
import {Directory, File} from '../../files.js';
import {withURLSeparator} from '../../utils/url.js';
import {MD_SUFFIX, EJS_SUFFIX, HTML_SUFFIX, LAYOUT_SUFFIX} from '../../constants.js';
 ...
 * @returns {string}
 */
export const computePageURLOf = (layout, pagesDirectory) => withURLSeparator(
  layout
    .source()
 ...
 * @returns {Page}
 */
export const createPage = (layout, {directories: {pages, contents, output}}) => {
