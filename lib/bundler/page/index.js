  ...
  async (page) => {
    ...
    if (page.content.source()) {
      ...
      if (hasCacheEntry(contentKeyDescriptor)) {
        ...
        // If the rawPageContent is not an empty string, compile it as the EJS file.
        const content = rawPageContent && await compileEjs(
          rawPageContent,
          createGlobalAPI({
            file: page.content,
            page,
    ...
    addCacheEntry(pageKeyDescriptor, html);
