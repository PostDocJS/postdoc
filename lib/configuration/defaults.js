...
/**
 * @callback APITagParser
 * @param {Object} tag
 * @param {Object} comment
 * @param {Object} parsedAPIComments
 ...
 *
 * @property {Object} apidocs
 * @property {Record<string, APITagParser>} apidocs.tags - custom definition of tags to parse and recognise in
 *   the source code.
 * @property {string} apidocs.template - A path to the template used for the apidoc page generation. 
 * @property {string} apidocs.outputDirectory - A directory name for the generated api doc files.
 *
...
export const DEFAULTS = {
  ...
  apidocs: {
    ...
    get template() {
      return join(DEFAULTS.directories.includes, 'default_apidocs_template.ejs');
    },
    tags: {}
  },
  ignore: {
