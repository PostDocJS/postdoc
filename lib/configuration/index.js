 ...
 *
 * @property {string} tests - Directory name for the tests.
 * @property {string} layouts - Directory name for the page layouts.
 * @property {string} contents - Directory name for the MD content files for pages.
 *
