  ...
  new CustomCommand('init')
    ...
    .action(async (options) => {
      ...
      const components = [
        ...
        {name: 'guide', path: join(workingDirectory, 'includes', 'guide.ejs')},
        {name: 'api_reference', path: join(workingDirectory, 'includes', 'api_reference.ejs')},
        {name: 'about', path: join(workingDirectory, 'includes', 'about.ejs'), data: {page: {content: 'This is the about page'}}},
