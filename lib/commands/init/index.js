...
import {createPage, createComponent, createCss} from '../../assets/manager.js';
/**
 * @param {string} name
 * @param {Date} duration
 */
...
export const init = () =>
  new CustomCommand('init')
    ...
    .action(async (options) => {
      ...
      const pages = [
        {name: 'homepage', path: join(workingDirectory, 'pages', 'homepage', 'index.ejs'), data: {page: {content: 'This is the homepage'}}},
        {name: 'guide', path: join(workingDirectory, 'pages', 'guide', 'index.ejs'), data: {page: {content: 'This is the guide page'}}},
        {name: 'api_reference', path: join(workingDirectory, 'pages', 'api_reference', 'index.ejs'), data: {page: {content: 'This is the api_reference page'}}},
        {name: 'about', path: join(workingDirectory, 'pages', 'about', 'index.ejs'), data: {page: {content: 'This is the about page'}}}
      ];
      
      const components = [
        {name: 'header', path: join(workingDirectory, 'includes', 'header.ejs')},
        {name: 'what_is_project', path: join(workingDirectory, 'includes', 'what_is_project.ejs'), data: {page: {content: 'This is the what_is_project page'}}},
        {name: 'installation', path: join(workingDirectory, 'includes', 'installation.ejs'), data: {page: {content: 'This is the installation page'}}},
        {name: 'usage', path: join(workingDirectory, 'includes', 'usage.ejs'), data: {page: {content: 'This is the usage page'}}},
        {name: 'concepts', path: join(workingDirectory, 'includes', 'concepts.ejs'), data: {page: {content: 'This is the concepts page'}}},
      ...
      for (const page of pages) {
        await createPage(page.name, page.path, page.data)();
      }
