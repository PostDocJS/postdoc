  ...
  new Command('page')
    ...
    .action(async (pageURI, {test}) => {
      ...
      MessageBuilder()
        ...
        .pipeIf(layoutCopyResult.isErr, warn);

      const contentCopyResult = await File()
        .setSource(content.source)
        .setDestination(content.destination)
      ...
      MessageBuilder()
        ...
        .pipeIf(contentCopyResult.isErr, warn);

      let testCopyResult = null;
      if (test) {
        ...
        MessageBuilder()
          ...
          .pipeIf(testCopyResult.isErr, warn);
      }

      MessageBuilder()
        .lineIf(
          () => layoutCopyResult.isOk() && contentCopyResult.isOk(),
          () =>
            LineBuilder()
              ...
              .phrase('page')
              .phrase(
                testCopyResult !== null && testCopyResult.isOk()
