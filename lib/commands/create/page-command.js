...
/**
 * Create a new page in the configured pages directory.
 * By prepending the page name with directories you can create nested pages.
 * The page doesn't require an extension and MD file will be created.
 * Optionally a default test suite will be created for this page if the `--test`
 * option is provided.
 *
 * @example
 * postdoc create page foo/bar/baz
 *
 * @since 0.1.0
 */
export const page = () =>
        ...
        .lineIf(
          ...
          () =>
            LineBuilder()
              ...
              .phrase("page")
              .phrase(isTestSuiteWritten ? "and a test suite are" : "is")
              .phrase("created.")
              .build(),
        )
        .lineIf(
