...
export const apidocs = (configuration) =>
  new CustomCommand('apidocs')
    ...
    .option('-o | --output', 'An output directory name where the MD or EJS files should be created.', configuration.apidocs.outputDirectory)
    .option('-t | --template', 'A path to the template that is used in the generation process.', configuration.apidocs.template)
