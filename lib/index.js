...
import {LineBuilder, MessageBuilder, Separator, warn} from './logger/index.js';
import {
  CONFIGURATION_ID,
...
const examineConfigurationAnalysis = (configuration, analysis) => {
  if (analysis.isDefaultLanguageImplicit) {
    MessageBuilder()
      .line(
        LineBuilder()
      ...
      .line(
        LineBuilder()
          ...
          .text('If you are using another language, please define it in the configuration file.')
          .build()
      )
