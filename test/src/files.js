  ...
  describe('Directory', function () {
    ...
    describe('.files', function () {
      ...
      it('should return only direct files, by default', async function (client) {
        ...
        client.assert.ok(files.map(({source}) => source()).every((path) => !path.includes('inner-file.md')));
      });
      ...
      it('should return files from inner directories if the "recursive" option is set to "true"', async function (client) {
        ...
        client.assert.ok(files.map(({source}) => source()).some((path) => path.includes('inner-file.md')));
      });
    });
    ...
    describe('.move', function () {
      ...
      it('should move the directory from the "source" path to the "destination" path', async function (client) {
        await Directory(path.join(tmpDir, 'toMove')).moveTo(path.join(tmpDir, 'toMoveCopy'));
      ...
      it('should return the Directory instance', async function (client) {
        ...
        const movedDirectory = await directory.moveTo(path.join(tmpDir, 'toMove'));
    ...
    describe('.create', function () {
      ...
      it('should return the Directory instance', async function (client) {
        const directory = Directory(path.join(tmpDir, 'single-non-existent-directory'));
      ...
      it('should recursively create directories', async function (client) {
        ...
        try {
          ...
          const isExists = Directory(path.join(tmpDir, 'deep/recursive/directory')).exists();
    ...
    describe('.remove', function () {
      ...
      it('should remove nested directories', async function (client) {
        const directory = Directory(path.join(tmpDir, 'deep/recursive/directory'));
